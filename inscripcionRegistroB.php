...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$nombre || !$apellido || !$dni || !$cuil || !$fechaNacimiento || !$calle || !$numero || !$barrio || !$localidad || !$provincia) {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO domicilios (calle, numero, idBarrio) VALUES (?, ?, ?)");
        if (!$stmt) {
